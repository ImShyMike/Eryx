...
To initialize a package, use `eryx package init <directory>`, this will create a new package in the specified directory with all the necessary files.

### Package Structure

The minimum package structure (generated by `init`) is:
